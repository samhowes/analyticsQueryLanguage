...
export class TodoLangGrammarParser extends Parser {
  ...
  public get ruleNames(): string[] {
    return TodoLangGrammarParser.ruleNames;
  }

  // @Override
  public get serializedATN(): string {
    return TodoLangGrammarParser._serializedATN;
  }
  ...
  public todoExpressions(): TodoExpressionsContext {
    let _localctx: TodoExpressionsContext = new TodoExpressionsContext(
      this._ctx,
      this.state
    );
  ...
  public addExpression(): AddExpressionContext {
    let _localctx: AddExpressionContext = new AddExpressionContext(
      this._ctx,
      this.state
    );
  ...
  public completeExpression(): CompleteExpressionContext {
    let _localctx: CompleteExpressionContext = new CompleteExpressionContext(
      this._ctx,
      this.state
    );
  ...
  public static get _ATN(): ATN {
    if (!TodoLangGrammarParser.__ATN) {
      TodoLangGrammarParser.__ATN = new ATNDeserializer().deserialize(
        Utils.toCharArray(TodoLangGrammarParser._serializedATN)
      );
    }
...
export class TodoExpressionsContext extends ParserRuleContext {
  ...
  public completeExpression(
    i?: number
  ): CompleteExpressionContext | CompleteExpressionContext[] {
    if (i === undefined) {
  ...
  public get ruleIndex(): number {
    return TodoLangGrammarParser.RULE_todoExpressions;
  }
  // @Override
...
export class AddExpressionContext extends ParserRuleContext {
  public ADD(): TerminalNode {
    return this.getToken(TodoLangGrammarParser.ADD, 0);
  }
  public TODO(): TerminalNode {
    return this.getToken(TodoLangGrammarParser.TODO, 0);
  }
  public STRING(): TerminalNode {
    return this.getToken(TodoLangGrammarParser.STRING, 0);
  }
  constructor(parent: ParserRuleContext | undefined, invokingState: number) {
    super(parent, invokingState);
  }
  // @Override
  public get ruleIndex(): number {
    return TodoLangGrammarParser.RULE_addExpression;
  }
  // @Override
  public enterRule(listener: TodoLangGrammarListener): void {
...
export class CompleteExpressionContext extends ParserRuleContext {
  public COMPLETE(): TerminalNode {
    return this.getToken(TodoLangGrammarParser.COMPLETE, 0);
  }
  public TODO(): TerminalNode {
    return this.getToken(TodoLangGrammarParser.TODO, 0);
  }
  ...
  public readonly ruleIndex: number =
    TodoLangGrammarParser.RULE_completeExpression;
  // @Override
  public enterRule(listener: TodoLangGrammarListener): void {
