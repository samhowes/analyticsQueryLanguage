...
import { TodoLangParserListener } from "./TodoLangParserListener";

export class TodoLangParser extends Parser {
	...
	public static readonly VOCABULARY: Vocabulary = new VocabularyImpl(TodoLangParser._LITERAL_NAMES, TodoLangParser._SYMBOLIC_NAMES, []);

	// @Override
	// @NotNull
	public get vocabulary(): Vocabulary {
		return TodoLangParser.VOCABULARY;
	}
	// tslint:enable:no-trailing-whitespace

	// @Override
	public get grammarFileName(): string { return "TodoLangParser.g4"; }

	// @Override
	public get ruleNames(): string[] { return TodoLangParser.ruleNames; }

	// @Override
	public get serializedATN(): string { return TodoLangParser._serializedATN; }

	constructor(input: TokenStream) {
		super(input);
		this._interp = new ParserATNSimulator(TodoLangParser._ATN, this);
	}
	// @RuleVersion(0)
	public todoExpressions(): TodoExpressionsContext {
		...
		this.enterRule(_localctx, 0, TodoLangParser.RULE_todoExpressions);
		let _la: number;
		try {
			...
			this._errHandler.sync(this);
			_la = this._input.LA(1);
			while (_la === TodoLangParser.COMPLETE) {
				{
				{
				this.state = 12;
	...
	public addExpression(): AddExpressionContext {
		...
		this.enterRule(_localctx, 2, TodoLangParser.RULE_addExpression);
		try {
			this.enterOuterAlt(_localctx, 1);
			{
			this.state = 18;
			this.match(TodoLangParser.ADD);
			this.state = 19;
			this.match(TodoLangParser.TODO);
			this.state = 20;
			this.match(TodoLangParser.STRING);
			}
		}
		catch (re) {
			if (re instanceof RecognitionException) {
	...
	public completeExpression(): CompleteExpressionContext {
		...
		this.enterRule(_localctx, 4, TodoLangParser.RULE_completeExpression);
		try {
			this.enterOuterAlt(_localctx, 1);
			{
			this.state = 22;
			this.match(TodoLangParser.COMPLETE);
			this.state = 23;
			this.match(TodoLangParser.TODO);
			this.state = 24;
			this.match(TodoLangParser.STRING);
	...
	public static get _ATN(): ATN {
		if (!TodoLangParser.__ATN) {
			TodoLangParser.__ATN = new ATNDeserializer().deserialize(Utils.toCharArray(TodoLangParser._serializedATN));
		}

		return TodoLangParser.__ATN;
	}
...
export class TodoExpressionsContext extends ParserRuleContext {
	...
	// @Override
	public get ruleIndex(): number { return TodoLangParser.RULE_todoExpressions; }
	// @Override
	public enterRule(listener: TodoLangParserListener): void {
		if (listener.enterTodoExpressions) {
			listener.enterTodoExpressions(this);
		}
	}
	// @Override
	public exitRule(listener: TodoLangParserListener): void {
...
export class AddExpressionContext extends ParserRuleContext {
	public ADD(): TerminalNode { return this.getToken(TodoLangParser.ADD, 0); }
	public TODO(): TerminalNode { return this.getToken(TodoLangParser.TODO, 0); }
	public STRING(): TerminalNode { return this.getToken(TodoLangParser.STRING, 0); }
	constructor(parent: ParserRuleContext | undefined, invokingState: number) {
		super(parent, invokingState);
	}
	// @Override
	public get ruleIndex(): number { return TodoLangParser.RULE_addExpression; }
	// @Override
	public enterRule(listener: TodoLangParserListener): void {
...
export class CompleteExpressionContext extends ParserRuleContext {
	public COMPLETE(): TerminalNode { return this.getToken(TodoLangParser.COMPLETE, 0); }
	public TODO(): TerminalNode { return this.getToken(TodoLangParser.TODO, 0); }
	public STRING(): TerminalNode { return this.getToken(TodoLangParser.STRING, 0); }
	constructor(parent: ParserRuleContext | undefined, invokingState: number) {
		super(parent, invokingState);
	...
	// @Override
	public get ruleIndex(): number { return TodoLangParser.RULE_completeExpression; }
	// @Override
	public enterRule(listener: TodoLangParserListener): void {
