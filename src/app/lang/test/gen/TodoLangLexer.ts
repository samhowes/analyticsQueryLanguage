// Generated from /Users/samh/dev/analyticsQueryLanguage/src/app/lang/test/TodoLangLexer.g4 by ANTLR 4.7.3-SNAPSHOT
...
export class TodoLangLexer extends Lexer {
	...
	public static readonly VOCABULARY: Vocabulary = new VocabularyImpl(TodoLangLexer._LITERAL_NAMES, TodoLangLexer._SYMBOLIC_NAMES, []);

	// @Override
	// @NotNull
	public get vocabulary(): Vocabulary {
		return TodoLangLexer.VOCABULARY;
	}
	...
	constructor(input: CharStream) {
		super(input);
		this._interp = new LexerATNSimulator(TodoLangLexer._ATN, this);
	}

	// @Override
	public get grammarFileName(): string { return "TodoLangLexer.g4"; }

	// @Override
	public get ruleNames(): string[] { return TodoLangLexer.ruleNames; }

	// @Override
	public get serializedATN(): string { return TodoLangLexer._serializedATN; }

	// @Override
	public get channelNames(): string[] { return TodoLangLexer.channelNames; }

	// @Override
	public get modeNames(): string[] { return TodoLangLexer.modeNames; }
	...
	public static get _ATN(): ATN {
		if (!TodoLangLexer.__ATN) {
			TodoLangLexer.__ATN = new ATNDeserializer().deserialize(Utils.toCharArray(TodoLangLexer._serializedATN));
		}

		return TodoLangLexer.__ATN;
	}
